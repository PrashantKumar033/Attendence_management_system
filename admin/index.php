...
<div class="content">
  ...
  <b><center><h4> Select: <a href="#teacher">Teacher</a> | <a href="">Student</a></h4> <br></center>
  </b>
  <div class="row" id="student">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_batch"  class="form-control" id="input1" placeholder="batch year ex. 2024" />
          </div>
      </div>
